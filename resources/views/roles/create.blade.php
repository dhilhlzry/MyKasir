    ...
    <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <h1 class="app-page-title">Create Roles</h1>
                <hr class="mb-4" />
                <div class="row g-4 settings-section">
                    <div class="col-12 col-md-8">
                        <div class="app-card app-card-settings shadow-sm p-4">
                            <div class="app-card-body">
                                <form action="roles-simpan" method="post" enctype="multipart/form-data" class="settings-form">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <label for="setting-input-3" class="form-label" style="margin-bottom: 10px">Permission Access :</label>
                                    @foreach ($permission as $list)
                                        <div class="form-check mb-3" style="margin-left: 10px">
                                            <input class="form-check-input" type="checkbox" name="permission[]" value="{{ $list->name }}"
                                    ...
                                    @endforeach
                                    <div class="flex">
                                        <a href="/roles" class="btn btn-secondary" style="margin-top: 10px; margin-right: 4px">
                                            Back
                                        </a>
