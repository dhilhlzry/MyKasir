                    ...
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                <div class="col-auto">
                                    <form action="/kategori" class="table-search-form row gx-1 align-items-center">
                                        <div class="col-auto">
                                            <input type="text" name="search_kategori" id="search_kategori"
                                                value="{{ request('search_kategori') }}" class="form-control search-orders"
                                                placeholder="Search">
                                        </div>
                                        <div class="col-auto">
                                            ...
                                            <tr>
                                                ...
                                                @foreach ($kategori as $list)
                                                    ...
                                                    <td class=""
                                                        ...
                                                        <a href="/detail_kategori/{{ $list->id }}"><span
                                                ...
                                                <div class="modal-dialog modal-dialog-scrollable">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="/kategori-update/{{ $list->id }}" method="post"
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        placeholder="Masukan Kategori" value="{{ $list->kategori }}" required />
                                                                </div>
                                                        </div>
                    ...
                    <form action="kategori-simpan" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="kode" name="kode"
                                @error('kode') is-invalid @enderror placeholder="Masukan No Kode" value="KTG{{ $kodeauto->invoice }}" readonly />
                            @error('kode')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
