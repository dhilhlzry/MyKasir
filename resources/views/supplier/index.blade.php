            ...
            <div class="container-xl">
                    ...
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                <div class="col-auto">
                                    <form action="/supplier" class="table-search-form row gx-1 align-items-center">
                                        <div class="col-auto">
                                            <input type="text" name="search_supplier" id="search_supplier"
                                                value="{{ request('search_supplier') }}" class="form-control search-orders"
                                                placeholder="Search">
                                        </div>
                                        <div class="col-auto">
                ...
                <div class="tab-content" id="orders-table-tab-content">
                    <div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                @foreach ($supplier as $list)
                                                    ...
                                                    <td class="cell">{{ $list->no_telp }}</td>
                                                    <td class="cell">{{ $list->alamat }}</td>
                                                    <td class="cell">
                                                    ...
                                                    <td class=""
                                                        ...
                                                        <a href="/detail_supplier/{{ $list->id }}"><span
                                                                class="status process"><i
                                                        ...
                                                        <form action="/delete_supplier/{{ $list->id }}" method="post">
                                                            @csrf
                                                            @method('delete')
                                                ...
                                                <div class="modal-dialog modal-dialog-scrollable">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="/supplier-update/{{ $list->id }}"
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        value="{{ $list->supplier }}" required />
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="setting-input-2" class="form-label">No
                                                                        Telp</label>
                                                                    <input type="text" class="form-control"
                                                                        id="no_telp" name="no_telp"
                                                                        placeholder="Masukan No Telp"
                                                                        value="{{ $list->no_telp }}" required />
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="setting-input-2"
                        ...
                        <div class="d-flex justify-content-center">{{ $supplier->links() }}</div>
                    </div><!--//tab-pane-->
                </div><!--//tab-content-->
            </div><!--//container-fluid-->
        </div><!--//app-content-->
                    ...
                    <form action="supplier-simpan" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="kode" name="kode"
                                ...
                                value="SP{{ $kodeauto->invoice }}" readonly />
                            @error('kode')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="supplier" name="supplier"
                                placeholder="Masukan Supplier" required />
                        </div>
                        <div class="mb-3">
                            <label for="setting-input-2" class="form-label">No Telp</label>
